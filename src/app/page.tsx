...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      avatars={[
        {
          src: "http://img.b2bpic.net/free-photo/beautiful-couple-love-black-wear_624325-273.jpg",
          alt: "beautiful couple in love in black wear",
        },
        {
          src: "http://img.b2bpic.net/free-photo/back-view-couple-holding-hands-outdoors_23-2149609652.jpg",
          alt: "Back view couple holding hands outdoors",
        },
        {
          src: "http://img.b2bpic.net/free-photo/romantic-engagement-happiness-couple-elegance_1153-2195.jpg",
          alt: "romantic engagement happiness couple elegance",
        },
        {
          src: "http://img.b2bpic.net/free-photo/newlyweds-looking-sunset-posing-hill_8353-12613.jpg",
          alt: "Newlyweds looking at sunset posing on hill",
        },
        {
          src: "http://img.b2bpic.net/free-photo/couple-holding-hands-looking-apple-orchard_107420-12217.jpg",
          alt: "happy bride and groom portrait candid",
        },
      ]}
      marqueeItems={[
        {
          type: "text",
          text: "Shenandoah Valley Based",
        },
        {
          type: "text",
          text: "Fully Licensed Officiant",
        },
        {
          type: "text",
          text: "Custom Vows",
      ...
      bulletPoints={[
        {
          ...
          description: "Committed to the bonds that matter most.",
        },
        {
          title: "Personalized Approach",
          description: "No cookie-cutter scripts, just your unique story.",
        },
        {
      ...
      features={[
        {
          ...
          subtitle: "Full Ceremony",
          category: "Standard",
          value: "Custom-written and tailored to your tone.",
        },
        {
          id: "2",
          title: "Elopements",
          subtitle: "Intimate Day",
          category: "Quick",
          value: "Beautiful ceremonies without the stress.",
        },
        {
          id: "3",
          title: "Vow Renewals",
          subtitle: "Recommitment",
          category: "Heartfelt",
          value: "Celebrate your journey together.",
        },
        {
          id: "4",
          title: "Travel Included",
          subtitle: "Valley-wide",
          category: "Local",
          value: "I’ll come to your chosen location.",
        },
      ]}
      ...
      features={[
        {
          ...
          subtitle: "Care",
          category: "Personal",
          value: "You won't feel like just another booking.",
        },
        {
          id: "b2",
          title: "Calm Professionalism",
          subtitle: "Presence",
          category: "Reliable",
          value: "A steady hand on your big day.",
        },
        {
          id: "b3",
          ...
          value: "Support from start to finish.",
        },
        {
          id: "b4",
          ...
          subtitle: "Fair",
          category: "Value",
          value: "Clear costs, no hidden surprises.",
        },
      ]}
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        ...
        },
        {
          ...
          date: "April 2023",
          title: "Bride",
          quote: "We couldn’t have asked for a better officiant for our day.",
          tag: "Excellent",
          avatarSrc: "http://img.b2bpic.net/free-photo/couple-newlyweds-smiling-groom-covering-bride-s-eyes-with-hands_176420-2253.jpg",
          imageSrc: "http://img.b2bpic.net/free-photo/young-couple-making-photos-forest_1303-22427.jpg",
          imageAlt: "happy bride and groom portrait candid",
        },
        {
          id: "4",
        ...
        },
        {
          ...
          date: "February 2023",
          title: "Bride",
          quote: "Andrew was a dream to work with—so accommodating and warm.",
          tag: "Wonderful",
          avatarSrc: "http://img.b2bpic.net/free-photo/happy-couple-smiling_1153-105.jpg",
          imageSrc: "http://img.b2bpic.net/free-photo/beautiful-couple-love-black-wear_624325-273.jpg",
          imageAlt: "happy bride and groom portrait candid",
        },
      ]}
      ...
      faqs={[
        {
          id: "p1",
          title: "Reach Out",
          content: "Send a message or request your date to start the conversation.",
        },
        {
          id: "p2",
          title: "Quick Call",
          content: "We'll talk through your vision, tone, and specific details.",
        },
        {
          id: "p3",
          title: "Custom Ceremony",
          content: "I craft a unique ceremony specifically tailored to your story.",
        },
        {
          id: "p4",
          title: "Your Big Day",
          content: "You show up, relax, and let me handle the rest.",
        },
      ]}
